...
exp(-.38)-1 # model estimates 31% reduction in waste piles
...
summ(m3_log, model.fit = FALSE) # coefficiant already in percent change - 42% reduction in waste piles
```
...
Pre-treatment counts of waste piles is higher in control group (they are not equal, could be selection bias). Can include pre count variable in model to control for these differences.
